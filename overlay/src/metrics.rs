...
pub struct OverlayMetrics {
    ...
    // Compact-block metrics (all from the perspective of the peer that
    // receives the compact set, not the one that broadcast it)
    /// overlay.compact.reconstructed-size — total bytes of tx sets reconstructed
    pub reconstructed_size: AtomicU64,
    /// overlay.compact.reconstructed-count — number of tx sets reconstructed
    pub reconstructed_count: AtomicU64,
    /// overlay.compact.compact-size — total bytes of compact sets received
    pub compact_size: AtomicU64,
    /// overlay.compact.compact-count — number of compact sets received
    pub compact_count: AtomicU64,
    /// overlay.compact.txs-requested — TXs requested in SetGetTxs messages
