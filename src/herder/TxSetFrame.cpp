...
createSurgePricingLangeConfig(TxSetPhase phase, Application& app)
{
    ...
    // releaseAssert(!app.getLedgerManager().isApplying().has_value());
...
{
    // TODO: any SCP synchroniation vs applying? RIGHT Now sequential aspect of
    // this is making synchronizatino EASIER.
    releaseAssert(threadIsMain());
    ...
    // TODO: what to do about LCL, need to anchor it without knowing the
    // results?
                               ...
                               LedgerHeader const& lclHeader) const
{
    ...
    {
        // TODO: good news is that this isn't the case anymore in protocol
