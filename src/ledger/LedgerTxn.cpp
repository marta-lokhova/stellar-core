                                  ...
                                  LedgerRange const& ledgers) const
{
    ...
    getSession() << query, into(count), use(first), use(limit);
    return count;
}
